import { GM_EDITOR_URL, GT_EDITOR_URL, RC_EDITOR_URL, TONEX_EDITOR_URL, VG_EDITOR_URL } from "../api";

export type EditorPlatformId = "rc-600" | "vg-800" | "gm-800" | "gt-1000" | "tonex";
...
export const EDITOR_PLATFORMS: { id: EditorPlatformId; label: string; url: string }[] = [
  ...
  { id: "gt-1000", label: "GT-1000 Editor", url: GT_EDITOR_URL },
